...
def rate_table(curve, x_grid=None, y_grid=None):
    ...
    >>> from yieldcurves import Curve, rate_table
    >>> curve = Curve([1, 4], [0, 1])
...
class Curve(object):
    ...
    INTERPOLATIONS = dict()
    """mapping (dict) of available interpolations
        additional to |yieldcurves.interpolation|"""
...
class DateCurve(Curve):
    ...
    """mapping (dict) of availiable day count functions
        additional to |yieldcurves.daycount|"""
...
class RateCurve(DateCurve):
    ...
    def __init__(self, domain=(), data=(), interpolation=None, origin=None,
        ...
        **interpolation**, **origin**, **day_count**, **forward_tenor**
        ...
        if compounding is None:
            self._compounding_rate = continuous_rate
            self._compounding_factor = continuous_compounding
        else:
            r, f = compounding
            ...
            self._compounding_rate = r
            self._compounding_factor = f
    ...
    def _get_compounding_factor(self, start, stop):
        ...
        return self._compounding_factor(ir, t)
    ...
    def _get_compounding_rate(self, start, stop):
        ...
        t = self.day_count(start, stop)
        return self._compounding_rate(df, t)
