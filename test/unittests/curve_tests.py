...
from yieldcurves.interpolation import linear, constant, _dyn_scheme as dyn_scheme

from yieldcurves import Curve, DateCurve, RateCurve
...
class CurveUnitTests(TestCase):
    ...
    def test_interpolation(self):
        ...
        yieldcurves_curve = Curve(self.x_list, self.y_list,
        ...
        for x in self.x_test:
            self.assertAlmostEqual(scipy_curve(x), yieldcurves_curve(x))
